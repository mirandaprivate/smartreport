...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:EPUGD69ou4Uw4c81t9NLh0+dSou46k4tFEvf498FJ0g=",
        version = "v2.18.0",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_go_ego_cedar",
        importpath = "github.com/go-ego/cedar",
        sum = "h1:422oGVkurGN2JZ0kiOev4hF6gsQULbePfjQIB4JHl8M=",
        version = "v0.10.0",
    )
    go_repository(
        name = "com_github_go_ego_gpy",
        importpath = "github.com/go-ego/gpy",
        sum = "h1:A8AByouCkPQd8HW9tbPgSU6t7G5FNa9inWtcsWp49tw=",
        version = "v0.31.0",
    )
    go_repository(
        name = "com_github_go_ego_gse",
        importpath = "github.com/go-ego/gse",
        sum = "h1:bzQiq6DyKgXaTiym3hOkBmr2FOtZdMHiHRUoT1aMsvA=",
        version = "v0.50.3",
    )
    go_repository(
        name = "com_github_go_ego_murmur",
        importpath = "github.com/go-ego/murmur",
        sum = "h1:n4AvncV+xqShlqNMvCUwIn00/SvIilcpsCZBOVS5FAc=",
        version = "v0.10.0",
    )
    go_repository(
        name = "com_github_go_ego_riot",
        importpath = "github.com/go-ego/riot",
        sum = "h1:dvhuTFXrHMU4+AYpheHkEwlnbsYbzlLE+tEWi/1cO3c=",
        version = "v0.0.0-20201013133145-f4c30acb3704",
    )
    ...
    go_repository(
        name = "com_github_go_gomail_gomail",
        importpath = "github.com/go-gomail/gomail",
        sum = "h1:Bao6dhmbTA1KFVxmJ6nBoMuOJit2yjEgLJpIMYpop0E=",
        version = "v0.0.0-20160411212932-81ebce5c23df",
    )
    ...
    go_repository(
        ...
        sum = "h1:5lQlCr1HL0ZVRPL+0PHKhRpMCSPMV2qF842rhQx8CYY=",
        version = "v0.19.12",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:4rWNJkj+aPuDFqgieTzNhHBuYaXREh3yaB9NlBerFys=",
        version = "v9.2.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:WrzNj+tp0pK8B5K5Sf4Rab0xvrIINiX0rrgqvW0fY0k=",
        version = "v0.23.0",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_go_vgo_grpclb",
        importpath = "github.com/go-vgo/grpclb",
        sum = "h1:tWgVtSQeg8f4cVBwHKH5q5saPMZNRvR5GSOx+ytAe9g=",
        version = "v0.0.0-20181128171039-89526b0a742e",
    )
    go_repository(
        name = "com_github_go_vgo_gt",
        importpath = "github.com/go-vgo/gt",
        sum = "h1:Yj5OZ0JtOxoPgV0jG77i+GNIHbWo1AhagvayRbHx6S4=",
        version = "v0.20.0",
    )
    go_repository(
        name = "com_github_go_vgo_gt_conf",
        importpath = "github.com/go-vgo/gt/conf",
        sum = "h1:shJeNwLPXz6yfhpQm8OOJS4R9HbQQ7JXDKQRxAptpE0=",
        version = "v0.0.0-20200606140533-a397c46789df",
    )
    go_repository(
        name = "com_github_go_vgo_gt_info",
        importpath = "github.com/go-vgo/gt/info",
        sum = "h1:ULtirwL4ObVnO6CrcLagDDk6k/GdB/QgHtxbd9xO13M=",
        version = "v0.0.0-20200606140533-a397c46789df",
    )
    go_repository(
        name = "com_github_go_vgo_zlog",
        importpath = "github.com/go-vgo/zlog",
        sum = "h1:2HUWQ9lbNl5i21Rxb+7ssnZ6z+zB5UYuywa+vhyGCE0=",
        version = "v0.0.0-20200606142114-9aade0d23ce3",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_minio_argon2",
        importpath = "github.com/minio/argon2",
        sum = "h1:cLB/fl0EeBqiDYhsIzIPTdLZhCykRrvdx3Eu3E5oqsE=",
        version = "v1.0.0",
    )
    go_repository(
        name = "com_github_minio_madmin_go",
        importpath = "github.com/minio/madmin-go",
        sum = "h1:lgAIfOI1xB+K2JFx5JqxklLS0SE7ya3qZIi1qmwjHNE=",
        version = "v1.3.6",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:NleyGQvAn9VQMU+YHVrgV4CX+EPtxPt/78lHOOTncy4=",
        version = "v7.0.23",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:iBZPTYkGLvdu6+A5TsMUJQkQX9Ad4aCEnSQtdxPuTCQ=",
        version = "v0.0.0-20191202183732-d1d2010b5bee",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:btgfyAuFo3uLw7eOrRDPo8H4Bc881+bSPHzAEe0ukho=",
        version = "v0.1.15",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:vU7jrp1Ic/2sHB7w6UNs7MIkn7ebVtTb5D9j45o9VYE=",
        version = "v3.21.6",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:3giwAkmtaEDLSV0MdO1lDLuPgklgPzmk8H9+So2BVfA=",
        version = "v1.1.3",
    )
    go_repository(
        name = "com_github_tklauser_go_sysconf",
        importpath = "github.com/tklauser/go-sysconf",
        sum = "h1:oc1sJWvKkmvIxhDHeKWvZS4f6AW+YcoguSfRF2/Hmo4=",
        version = "v0.3.6",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:jPtFiRRnCOXVakd5ujCed2dwWwTs91wh8W1iHeUIfc0=",
        version = "v0.10.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:nDDVfX0qaDuGjAvb+5zTd0Bxxoqa1Ffv9B4kiE23PTM=",
        version = "v2.5.0",
    )
    ...
    go_repository(
        ...
        sum = "h1:qXVcIR1kU3CYLD8zXDseOmBNwg0uaui53e4Wg4uj0rk=",
        version = "v3.3.10+incompatible",
    )
    go_repository(
        name = "io_gorm_driver_mysql",
        importpath = "gorm.io/driver/mysql",
        sum = "h1:3PgFPJlFq5Xt/0WRiRjxIVaXjeHY+2TQ5feXgpSpEC4=",
        version = "v1.1.0",
    )
    go_repository(
        name = "io_gorm_driver_postgres",
        importpath = "gorm.io/driver/postgres",
        sum = "h1:afBljg7PtJ5lA6YUWluV2+xovIPhS+YiInuL3kUjrbk=",
        version = "v1.1.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:kBGiBsaqOQ+8f6S2U6mvGFz6aWWyCeIiuaFcaBozp4M=",
        version = "v1.21.10",
    )
    ...
    go_repository(
        ...
        sum = "h1:A0Qkn7Z/n8zC1xd9LTw17AiKlBRK64tw3ejWQiEqca0=",
        version = "v0.0.0-20211213223007-03aa0b5f6827",
    )
    go_repository(
