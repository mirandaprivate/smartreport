...
import {LogiSizeDSType} from '@logi/src/app/base/types'
import {addClass, removeClass} from '@logi/src/app/base/utils'
...
@Component({
    ...
    styleUrls: [
        ...
        './style.css',
        './logi_button.style.css',
        './logi_flat_button.style.css',
        './logi_icon_button.style.css',
        './logi_icon_text_button.style.css',
        './logi_stroked_button.style.css',
    ],
