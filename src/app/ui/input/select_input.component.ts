...
import {assertIsHTMLInputElement} from '@logi/src/app/base/utils'
import {
    CanDisable,
    CanDisableCtor,
    mixinDisabled,
} from '@logi/src/app/ui/core'
import {LogiInputDirective} from '@logi/src/app/ui/input'
...
@Component({
    ...
    styleUrls: ['./select_input.style.css'],
