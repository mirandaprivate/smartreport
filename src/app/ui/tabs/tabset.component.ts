...
import {LogiSizeLDSType} from '@logi/src/app/base/types'
import {toNumber, toObservable} from '@logi/src/app/base/utils'
import {SplitAreaDirective, SplitComponent} from '@logi/src/app/ui/split'
...
@Component({
    ...
    styleUrls: [
        './logi_style/logi_box.css',
        './logi_style/logi_panel.css',
        './logi_style/logi_sheet.css',
        './tabset.style.css',
    ],
